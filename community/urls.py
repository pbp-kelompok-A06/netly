...
from community.views import fetch_forum, fetch_forum_creator, fetch_forum_joined, fetch_post_id_user, create_forum, delete_forum, join_forum, fetch_forum_id, update_forum, fetch_post_id, create_post, unjoin_forum, delete_forum_post
app_name = 'community'
